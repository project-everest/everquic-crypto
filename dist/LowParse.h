...
bool LowParse_Low_Base_is_error(uint64_t positionOrError);

#define LOWPARSE_LOW_BASE_VALIDATOR_ERROR_GENERIC ((uint64_t)4294967296U)

#define LOWPARSE_LOW_BASE_VALIDATOR_ERROR_NOT_ENOUGH_DATA ((uint64_t)8589934592U)
